...
theory MS_Test_TAO
imports 
  PLM.TAO_8_Definitions MS_Translator
...
\     apply (insert assms) apply simp\n\
\    by (simp add: assms(2))"\<close>
  ...
  lemma rule_sub_remark_4:
    ...
    using assms apply PLM_autosubst1 by auto
ML_val \<open>val _ =  MinLang_Translator.translate'm  @{Isar.state} 
    "apply (insert assms) apply PLM_autosubst1 by auto"s \<close>
