...
theory MS_Test_CryptHOL imports 
...
lemma asm_rl_conv: "(PROP P \<Longrightarrow> PROP P) \<equiv> Trueprop True"
  ...
  by (min_script \<open>
RULE 
(*goal: "\<lbrakk>PROP P \<Longrightarrow> PROP P; True\<rbrakk> \<Longrightarrow> PROP P" and "\<lbrakk>PROP P \<Longrightarrow> PROP P\<rbrakk> \<Longrightarrow> True" *)
  INTRO
  (*introduces facts assm0: "PROP P \<Longrightarrow> PROP P" and assm1: True *)
  SIMP WITH assm0[where PROP = asm_rl] \<open>True\<close>
(*no goal remains!*)
NEXT
  (*goal: "\<lbrakk>PROP P \<Longrightarrow> PROP P\<rbrakk> \<Longrightarrow> True" *)
END
\<close>)
