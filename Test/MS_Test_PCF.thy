...
imports
  PCF.Basis
  PCF.Logical_Relations Minilang_Translator.MS_Translator
begin
...
(*<*)   
  ML_val \<open> error (Thor.translate_thor_src true @{Isar.state}
(File.read (Path.explode "/home/xero/Current/Isa-Mini/translator/Test/t42.txt")))
\<close>
