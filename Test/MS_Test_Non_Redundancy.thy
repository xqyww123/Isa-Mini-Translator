theory MS_Test_Non_Redundancy
  imports
    Simple_Clause_Learning.SCL_FOL
    Simple_Clause_Learning.Trail_Induced_Ordering
    Simple_Clause_Learning.Initial_Literals_Generalize_Learned_Literals
    Simple_Clause_Learning.Multiset_Order_Extra Minilang_Translator.MS_Translator
begin
...
(File.read (Path.explode "./Test/t51.txt"))\<close>
