...
theory MS_Test_Algebra3 imports "Group-Ring-Module.Algebra2" Minilang_Translator.MS_Translator begin
...
lemma (in Group) contain_commutator:"\<lbrakk>G \<guillemotright> H; (commutators G) \<subseteq> H\<rbrakk> \<Longrightarrow> G \<triangleright> H" 
  thm Group_Gp[of "H"]
  by (min_script \<open>
APPLY (fold Group_Gp[of "H"])
(*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> gcsrpgrp G H" *)
RULE Group.gcsrp [of "G" "H"]
(*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> Group G" and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> G \<guillemotright> H " and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> \<one>\<^bsub>G\<^esub> \<in> H" and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> \<one>\<^bsub>G\<^esub> \<in> H" and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> H \<subseteq> carrier G" and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> group H" and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub> = (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub>))" and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub> = (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub>))" and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> H \<subseteq> carrier G" and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> H \<noteq> {}" and "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> \<forall>a\<in>H. \<forall>b\<in>H. a \<cdot>\<^bsub>G\<^esub> b \<cdot>\<^bsub>G\<^esub> \<rho>\<^bsub>G\<^esub> a \<in> H" *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> G \<guillemotright> H " *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> \<one>\<^bsub>G\<^esub> \<in> H" *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> \<one>\<^bsub>G\<^esub> \<in> H" *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> H \<subseteq> carrier G" *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> group H" *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub> = (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub>))" *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub> = (\<cdot>\<^bsub>G\<^esub>) \<circ> (\<cdot>\<^bsub>G\<^esub>))" *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> H \<subseteq> carrier G" *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> H \<noteq> {}" *)
NEXT
  (*goal: "\<lbrakk>G \<guillemotright> H ; commutators G \<subseteq> H\<rbrakk> \<Longrightarrow> \<forall>a\<in>H. \<forall>b\<in>H. a \<cdot>\<^bsub>G\<^esub> b \<cdot>\<^bsub>G\<^esub> \<rho>\<^bsub>G\<^esub> a \<in> H" *)
END
\<close>)
