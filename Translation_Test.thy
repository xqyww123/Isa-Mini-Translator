...
ML \<open>ML_Translator_Top.translate_file "/home/xero/repo/Isabelle2023/src/HOL/Library/Sublist.thy"\<close>

ML \<open>ML_Translator_Top.init_translator (Path.explode "/tmp/xxx")
                                      (ML_Translator_Top.interactive_reporter ())\<close>

ML \<open>ML_Translator_Top.translate_file "/home/xero/repo/Isabelle2023/src/HOL/Library/IArray.thy"\<close>
 
   
ML \<open>ML_Translator_Top.init_translator (Path.explode "/tmp/xxx")
                                      (ML_Translator_Top.interactive_reporter ())\<close>
  
ML \<open>ML_Translator_Top.translate_file "/home/xero/repo/Isabelle2023/src/HOL/Library/Infinite_Set.thy"\<close>
 
ML \<open>ML_Translator_Top.init_translator (Path.explode "/tmp/xxx")
                                      (ML_Translator_Top.interactive_reporter ())\<close>

ML \<open>ML_Translator_Top.translate_file "/home/xero/repo/Isabelle2023/src/HOL/Library/Omega_Words_Fun.thy"\<close>
